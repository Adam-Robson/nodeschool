/* 
DUPLEXER - Write a program that exports a function that spawns 
  a process from a cmd string and an args array and returns a
  single duplex stream joining together the stdin and stdout
  ...
  signature of the exported function is duplexer2([options], writable,
...
module.exports = (cmd, args) => {
  ...
  // Use duplexer2 to join the child process's stdin and stdout into a single duplex stream
